...
object ItemRepository {
    ...
    val items: List<CatalogItem> = listOf(
        ...
        CatalogItem(
            ...
            category = Category.THAI,
            imageName = "bangkokbrothers_logo1"
        ),
        CatalogItem(
